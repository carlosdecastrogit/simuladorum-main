...
<div class="wrapper">
    ...
    <?php
        ...
        include "modulos/calendario-c.php";
            ...
            <div class="row justify-content-center">
                                ...
                                <form action="calendario-c.php" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="txtNro">Nro (*)</label>
                                            <input type="text" class="form-control" name="txtNro" placeholder="" value="<?php echo $txtNro; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtId">ID (*)</label>
                                            <input type="text" class="form-control" name="txtId" placeholder="" value="<?php echo $txtId; ?>" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" aria-label="With textarea" name="txtObservacion" value="<?php echo $txtObservacion; ?>"><?php echo $txtObservacion; ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                ...
                <?php } else{ ?>
                    ...
                    <form action="calendario-c.php" method="post">
                        <div class="row">
                            <div class="col-12">
                                <input type="hidden" name="txtnNro" value="<?php $txtNro; ?>">
